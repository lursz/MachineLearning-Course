        ...
        while queue:
            ...
            for neighbor in self.graph[node]:
                if neighbor not in visited:
                    if coloring[neighbor].color == self.color:
                        coloring[neighbor].color = self.old_color
                        queue.append(neighbor)
                    elif coloring[neighbor].color == self.old_color:
                        coloring[neighbor].color = self.color
                        queue.append(neighbor)
